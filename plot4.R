...
plot(Epower$DateTime, as.numeric(as.character(Epower$Global_active_power)),
     type = "l",
...
plot(Epower$DateTime, as.numeric(as.character(Epower$Voltage)),
     type = "l", 
     ylab = "Voltage", 
     xlab = "datetime")

plot(Epower$DateTime, as.numeric(as.character(Epower$Global_reactive_power)),
     type = "l", 
